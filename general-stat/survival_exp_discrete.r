...
# illustration for Fiona 
# show the equivalence between parametric and discrete
# parametric model with exp distribtion is the same
# as intercept logistic model using person-period data
# equivalance in the same of likelihood function is proportional
set.seed(2345)
